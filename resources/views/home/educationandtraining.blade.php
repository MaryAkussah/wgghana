...
<br>
    ...
    <div class="col">
        <div class="panel vstack gap-2 xl:gap-3">
            ...
            <div class="panel vstack items-start gap-narrow">
                <h6 class="h6 xl:h5 m-0">MR. RAYMOND HARRY OKITY</h6>
    ...
    <div class="col">
        <div class="panel vstack gap-2 xl:gap-3">
            <img class="w-100 rounded-1 sm:rounded-1-5" src="../home/images/fred.jpg" alt="Nikolas Gibbons">
            <div class="panel vstack items-start gap-narrow">
                <h6 class="h6 xl:h5 m-0">MR.FRED FRIMPONG BENNEH</h6>
                <span class="fs-6 xl:fs-5 text-primary dark:text-white dark:text-opacity-70">CLIENT SERVICE OFFICER</span>
            </div>
        </div>
    </div>
    <div class="col">
        <div class="panel vstack gap-2 xl:gap-3">
            <img class="w-100 rounded-1 sm:rounded-1-5" src="../home/images/daniel.jpg" alt="Another Person">
            <div class="panel vstack items-start gap-narrow">
                <h6 class="h6 xl:h5 m-0">MR. DANIEL NELSON</h6>
                <span class="fs-6 xl:fs-5 text-primary dark:text-white dark:text-opacity-70">CLIENT SERVICE OFFICER</span>
            </div>
        </div>
    </div>
